...
pub struct Descriptors {
    pub bip: String,
    pub full_addr_type: AddressType,
...
pub fn get_descriptors(seed: &[u8], network: Network, account_index: u32) -> anyhow::Result<Vec<Descriptors>> {
    ...
    let descriptor_templates = vec![
        NgDescriptorTemplate {
            bip: String::from("49"),
            full_addr_type: AddressType::P2ShWpkh,
        ...
        NgDescriptorTemplate {
            bip: String::from("44"),
            full_addr_type: AddressType::P2pkh,
        ...
        NgDescriptorTemplate {
            bip: String::from("84"),
            full_addr_type: AddressType::P2wpkh,
        ...
        NgDescriptorTemplate {
            bip: String::from("86"),
            full_addr_type: AddressType::P2tr,
        ...
        NgDescriptorTemplate {
            ...
            full_addr_type: AddressType::P2ShWsh,
        ...
        NgDescriptorTemplate {
            ...
            full_addr_type: AddressType::P2wsh,
        ...
        NgDescriptorTemplate {
            ...
            full_addr_type: AddressType::P2sh,
    ...
    for template in descriptor_templates {
        let (bip, full_addr_type, descriptor, key_map, change_descriptor, change_key_map) = (
            template.bip,
            template.full_addr_type,
