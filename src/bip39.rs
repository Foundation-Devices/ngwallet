...
mod test {
    ...
    fn test_get_descriptor_from_seed() {
        ...
        assert_eq!(get_descriptors(mnemonic, Bip84, Network::Bitcoin, None).unwrap().descriptor, "wpkh(xprv9s21ZrQH143K2v9ABLJujuoqaJoMuazgoH6Yg4CceWQr86hPGbE5g6ivqRnPPGTnt6GqZVTFecYEUzkB9rzj79jGenWLW9GVsG5i6CKmMAE/84'/0'/0'/0/*)#5aaucexa".to_owned());
    }
