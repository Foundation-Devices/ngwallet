...
mod spend_tests {
    ...
    fn test_max_fee_calc() {
        ...
        let params = TransactionParams {
            ...
            amount: 2003,
            fee_rate: 1000, // 1 sat/vB in sat/kvB
        ...
        assert_eq!(draft.max_fee_rate, 553_828); // 138_457 sat/kwu * 4 = sat/kvB
        assert_eq!(draft.min_fee_rate, 1000);   // 1 sat/vB in sat/kvB
    ...
    fn test_compose_psbt() {
        ...
        let params = TransactionParams {
            address: "tb1pspfcrvz538vvj9f9gfkd85nu5ty98zw9y5e302kha6zurv6vg07s8z7a8w".to_string(),
            amount: 4000,
            fee_rate: 2000, // 2 sat/vB in sat/kvB
            selected_outputs: vec![],
            note: Some("not a note".to_string()),
            tag: Some("hello".to_string()),
            do_not_spend_change: false,
    ...
    fn test_rbf() {
        ...
        assert_eq!(rbf_max_result.max_fee_rate, 126_896); // 31_724 sat/kwu * 4 = sat/kvB
